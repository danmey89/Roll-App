...
filepath = "test_data\\pathbuilder_test.json"

trs = get_json(filepath)
trs = trs["build"]
modifier_dict = get_json("test_data\\modifier_keyes.json")


abilities = {'str': trs["abilities"]['str'], 'dex': trs["abilities"]['dex'], 'con': trs["abilities"]['con'],
             'int': trs["abilities"]['int'], 'wis': trs["abilities"]['wis'], 'cha': trs["abilities"]['cha']}
...
proficiencies = {'perception': [trs["proficiencies"]['perception'], "wis", ""],
                 'fortitude': [trs["proficiencies"]['fortitude'], "con", ""],
                 'reflex': [trs["proficiencies"]['reflex'], "dex", ""],
                 'will': [trs["proficiencies"]['will'], "wis", ""],
...
char = {'name': trs["name"], 'class': trs["class"], 'level': trs["level"], "abilities": abilities,
